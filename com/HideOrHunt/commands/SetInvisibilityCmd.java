...
public class SetInvisibilityCmd implements CommandExecutor {
  private HideOrHunt plugin;
  
  public SetInvisibilityCmd(HideOrHunt plugin) {
    this.plugin = plugin;
    plugin.getCommand("setinvisibility").setExecutor(this);
  }
